...
const Verified_workforceScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get('http://www.kushalkaamgar.com/kk.api/workforce/getverifiedlist/en', {
                headers: {
        ...
        <View style={styles.item}>
            ...
            <View style={styles.buttoncontainer}>
                <TouchableOpacity style={styles.buttonstyle}
                    onPress={() => navigation.navigate('ViewVerifiedWorkforceDetails', {
                        param1: item.id,
                    })}
                >
                    <Text>View</Text>
...
export default Verified_workforceScreen;
