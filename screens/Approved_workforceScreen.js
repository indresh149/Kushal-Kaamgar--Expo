...
const Approved_workforceScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get('http://www.kushalkaamgar.com/kk.api/workforce/getapprovedlist/en', {
                headers: {
...
export default Approved_workforceScreen;
